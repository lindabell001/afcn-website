      ...
      <main className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white rounded-3xl p-8">
            ...
            <button className="mt-8 bg-patriot-blue text-white px-12 py-6 rounded-3xl text-xl font-bold">Browse Podcasters</button>
          </div>

          <div className="bg-white rounded-3xl p-8">
            <h2 className="text-3xl font-bold mb-6">Fan Club Chats</h2>
            <p className="text-gray-600">Private chats for your loyal listeners.</p>
            <button className="mt-8 bg-white border-2 border-patriot-blue text-patriot-blue px-12 py-6 rounded-3xl text-xl font-bold">Manage Fan Clubs</button>
          </div>
        </div>
