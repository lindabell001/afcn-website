      ...
      <main className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h2 className="text-4xl font-bold text-patriot-blue mb-4">Episode Calendar</h2>
            <p className="text-xl text-gray-600">View all episodes by date</p>
            <p className="mt-8 text-patriot-red font-semibold group-hover:underline">Open Calendar →</p>
          </Link>
